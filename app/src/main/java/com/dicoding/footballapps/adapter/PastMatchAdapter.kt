...
class PastMatchAdapter (
    private val dataItems: MutableList<MatchItem>,
    private val listener: PastMatchFragment.OnFragmentInteractionListener?)
    : RecyclerView.Adapter<PastMatchAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view)  {
        ...
        fun bindItem(item: MatchItem, listener: PastMatchFragment.OnFragmentInteractionListener?) {
